...
<!-- **** you need to in your own description in the content below -->	
	<meta name="description" content="Business Major and Computer Science Minor!" >

<!-- **** you need to in your name in the content below -->
	<meta name="author" content="Samuel Colburn" >
...
<div id="hcard-Samuel-Colburn" class="vcard">
...
<h1 id="name"><a class="url fn" href="http://www.github.com/samuelcolburn">Samuel Colburn</a></h1>
...
once to display -->		
    <span class="value"><a class="email" href="mailto:samuel.colburn@uvm.edu">samuel.colburn@uvm.edu</a></span>
</div>

<!-- ****  type in your contact numbers, delete extra, copy if you need more -->
<div class="tel">
    <span class="type">Cell: </span>
    <span class="value">1.802.236.1033</span>
</div>
...
<li class="school" id="american">
    <span class="dates">2009 - 2010</span>
    <a href="http://www.american.edu/" class="institution">American University</a>, 
    <a href="https://www.google.com/maps/place/American+University" 
class="location">Washington, DC</a>

    <span class="MajorDegree">Economics</span>
...
<ol>
    <li class="job">
        ...
        <a href="https://www.facebook.com/MetroBakeryCafe" class="company">Metro Bakery & Cafe</a>,  
        <a href="http://maps.google.com/" class="location">Hanover, NH</a>
  ...
  <li class="job">
        ...
        <p class="description"> Lead the second team of the 10-12 age group as head coach in the fall season. Taught teamwork, game concepts, and fundamental skills.  </p>
    </li><!-- end of this job -->
