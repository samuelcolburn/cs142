...
if (isset($_POST["btnSubmit"]) AND empty($errorMsg)) { // closing of if marked with: end body submit
    ...
    print "<h2>Your Profile Has been updated!</h2>";
    print "<img src='pics/cute-puppy-and-kitten.jpg' alt='cute puppy and kitten'>";
    print "</section>";
} else {
//####################################
//
...
//
    ...
    <?php if ($gender == "Other") print 'checked="checked"'; ?>
                    ...
                    <textarea id='txtAboutMe' name=AboutMe rows=5 maxlength= <?php
