<footer>
  <div>
    <a href="home.php"><img id="footer-logo" src="pics/logo.gif" alt="logo"></a>
    <ul>
  ...
  <ul id="footer-nav">
    ...
    <li><a href="petlist.php">Pets</a></li>
  </ul>
  <p>burlingtonanimals.com was created by William Kniffin and Sam Colburn. Copyright 2015.</p>
</footer>