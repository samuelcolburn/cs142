...
<article id="main">
    <section id="home-intro">
        ...
        <a id="pets-button" href="petlist.php"><h3>Adopt Today</h3></a>
        <ul>
    ...
    <section id="featured-pets">
        <h2>Featured pets</h2>
        <article>
            <a href="https://wkniffin.w3.uvm.edu/cs142/assignment7-version-two/pet.php?id=16">
                <div>
            ...
            <a href="https://wkniffin.w3.uvm.edu/cs142/assignment7-version-two/pet.php?id=2">
                <div>
