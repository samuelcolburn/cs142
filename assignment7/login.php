...
// form. Note it is best to follow the same order as declared in section 1c.
    ...
    $petID = htmlentities($_POST["hidpetID"], ENT_QUOTES, "UTF-8");
        ...
        if ($petID == "") {
            ...
            <script type="text/javascript">
                <!--
                        function delayer() {
                            var petid = $("p").attr("id");
                    window.location = "pet.php?id="+petid;
                }
                //-->
            </script>
            <!--TIMER -->
            <body onLoad="setTimeout('delayer()', 0000)"> 
                <p id ="<?php print $petID ?>">You should be redirected to the home page. If not, click this link: <a href ='home.php'> home</a>.</p>
                ...
                <fieldset class="wrapper">
                    ...
                    <fieldset class="wrapperTwo">
                        ...
                        <fieldset class="contact">
                            <legend></legend>
                            <input type="hidden" id="petID" name="hidpetID"
