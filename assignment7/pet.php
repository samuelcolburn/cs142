...
// PET INFO LOOP
    ...
    print "<div id='message-info'>Click the email button and we will contact you with more information!</div>";
    ...
    if ($_SESSION["user"]) {
        ...
        print "<p class='EmailButton-login'><a href='login.php?id=".$PetID."'>Email</a></p>";
    }
